...
<div class="list-group w-50 mt-5" style="min-width: 30px;" id="left">
	...
	<button type="button" class="list-group-item list-group-item-action <c:if test="${address == 5 }"> active </c:if>" 
	onclick="location.href='/writer/list.do?address=5'">의뢰 게시판</button>	
	<button type="button" class="list-group-item list-group-item-action" onclick="location.href='/map/mymap.do'">Priend 찾기</button>
	...
	<div class="collapse" id="myinfo">
		<div class="list-group bg-secondary">
			...
			<button id="lg" type="button" 
			class="list-group-item list-group-item-secondary list-group-item-action">개인정보</button>
		</div>
	</div>
